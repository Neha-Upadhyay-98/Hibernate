package com.capgemini.hibernatehandsonpractice.util;
...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory() {
		...
		if (sessionFactory == null) {
			try {
				/*
				 * An instance/object of Configuration allows the application to specify db
				 * properties and mappings used when creating a dbsession using SessionFactory
				 */
				Configuration cfg = new Configuration();
				/*
				 * This class contains key,value pair both are string it is subclass of
				 * Hashtable can be used to represent persistent set of properties
				 */
				...
				/*
				 * this contains contract that make up the hibernate native bootstrapping API to
				 * register the application with hibernate.
				 */
				ServiceRegistry srvReg = new StandardServiceRegistryBuilder().applySettings(cfg.getProperties())
						.build();
